...
SOURCE_DIR = ROOT_DIR / "battle_candidates_v2"
OUTPUT_DIR = ROOT_DIR / "sword_battle_pack_ready"
RESOURCE_DIR = ROOT_DIR / "Tappy" / "Resources" / "BundledSounds" / "sword-battle"
SELECTION_FILE = ROOT_DIR / "sword_battle_pack_selection.json"

DEFAULT_PACK_SELECTION = {
    "default": [
        ("freesound_crunchpixstudio-rpg-sword-attack-combo-20-388935", "00_full_trimmed.wav"),
        ("freesound_crunchpixstudio-rpg-sword-attack-combo-22-388940", "00_full_trimmed.wav"),
        ("dragon-studio-hard-punch-sfx-515251", "00_full_trimmed.wav"),
        ("storegraphic-punch-and-hits-310521", "00_full_trimmed.wav"),
        ("storegraphic-punch-and-hits-310521", "02_t0002.123_score13418.wav"),
        ("storegraphic-punch-and-hits-310521", "05_t0006.832_score10505.wav"),
        ("storegraphic-punch-and-hits-310521", "08_t0012.348_score11206.wav"),
        ("storegraphic-punch-and-hits-310521", "04_t0005.064_score11073.wav"),
        ("universfield-punch-03-352040", "01_t0000.335_score12526.wav"),
    ],
    "space": [
        ("freesound_crunchpixstudio-cloud-spread-394490", "00_full_trimmed.wav"),
    ],
    "return": [
        ("freesound_crunchpixstudio-rpg-sword-attack-combo-34-388950", "00_full_trimmed.wav"),
    ],
    "delete": [
        ("freesound_crunchpixstudio-rpg-sword-attack-combo-12-388934", "00_full_trimmed.wav"),
    ],
    "modifier": [
        ("freesound_crunchpixstudio-rpg-sword-attack-combo-20-388935", "00_full_trimmed.wav"),
    ],
...
CATEGORY_SETTINGS = {
    "default": {"target_peak": 0.38, "output_ms": 96, "fade_in_ms": 4.0, "fade_out_ms": 28.0},
    "space": {"target_peak": 0.30, "output_ms": 180, "fade_in_ms": 4.0, "fade_out_ms": 34.0},
    "return": {"target_peak": 0.34, "output_ms": 220, "fade_in_ms": 4.0, "fade_out_ms": 38.0},
    "delete": {"target_peak": 0.32, "output_ms": 160, "fade_in_ms": 3.5, "fade_out_ms": 30.0},
    "modifier": {"target_peak": 0.28, "output_ms": 150, "fade_in_ms": 3.5, "fade_out_ms": 28.0},
}
...
def build_pack() -> None:
    ...
    readme_contents = "\n".join(
        [
            "Tappy Sword Battle tech pack",
            "",
            "Source vibe:",
            "- sword slashes, impact swipes, and airy battle effects",
            "- short default attacks with fuller cinematic special-key hits",
            "",
            "Categories:",
...
if __name__ == "__main__":
    build_pack()
    print(f"Built sword battle pack at {OUTPUT_DIR}")
    print(f"Copied sword battle resources to {RESOURCE_DIR}")
